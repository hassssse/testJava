...
public class SelectProcess {
  ...
  public SelectProcess(String customName) throws SQLException {
    conn = null;
    stmt = null;
  ...
  //検索のメソッド(受注検索用)
  //顧客名からの検索
  public void selectOrderListByCustomName(String customName) throws SQLException {
    String sql;
  ...
  //受注Ｎｏ．からの受注商品リスト
  public void selectItemListByOrderNumber(SelectOrderResult orderResult) throws SQLException {
    stmt = conn.prepareStatement(sql2);
    stmt.setInt(1, orderResult.getOrderNo());
    resultSet2 = stmt.executeQuery();
    while (resultSet2.next()) {
